...
[![Screenshot of the website](img/logo.png)](https://www.pasanggiatso.be/)
...
On closer inspection, though, the limitation isn't the aesthetic itself but its single-page implementation. A notebook naturally affords growth: pages, tabs, an index. As my portfolio expands — which it will — the plan is to lean further into the metaphor rather than abandon it: individual projects "turning the page" onto their own case-study spreads, with the homepage acting as the notebook's index.
